...
@SubCommand("withdraw")
@HasPermission("lmke-wallet.wallet.withdraw")
public class WalletWithdrawCommand extends CommandBase {
    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command command, String[] args) {
        ...
        if (Utils.isEconomyNumber(args[0])) {
            ...
            sender.sendMessage(MsgLocaleManager.getChatText("wallet.withdraw", Utils.getCurrencyString(amount)));
        ...
        sender.sendMessage(MsgLocaleManager.getChatText("wallet.withdraw_other", w.playerName, Utils.getCurrencyString(amount)));

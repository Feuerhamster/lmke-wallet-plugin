...
@SubCommand("add")
@HasPermission("lmke-wallet.wallet.add")
public class WalletAddCommand extends CommandBase {
    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command command, String[] args) {
        ...
        if (Utils.isEconomyNumber(args[0])) {
            ...
            sender.sendMessage(MsgLocaleManager.getChatText("wallet.add", Utils.getCurrencyString(amount)));
        ...
        sender.sendMessage(MsgLocaleManager.getChatText("wallet.add_other", w.playerName, Utils.getCurrencyString(amount)));
